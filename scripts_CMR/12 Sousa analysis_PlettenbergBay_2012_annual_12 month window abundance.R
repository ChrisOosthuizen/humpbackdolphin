...
# SOusa analysis with JS model model for 2012/13 EHM data
...
n_months   <- ncol(CH)          # 17
window_len <- 12
n_windows  <- n_months - window_len + 1   # 6
...
for (i in 1:n_windows) {
  ...
  saveRDS(JS_mod_list[[i]],
          file = paste0("./scripts_CMR/BUGSmodel/JS_sousa_2012_Plettenberg_win", i, ".rds"))
}

# Save the full list of results
saveRDS(JS_mod_list, file = "./scripts_CMR/BUGSmodel/JS_sousa_2012_Plettenberg_allwindows.rds")
