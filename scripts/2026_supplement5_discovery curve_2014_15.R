...
dat = read.csv("./data/discoverycurve2014.csv", header = T)
head(dat)
str(dat)
...
## Save Plot 
pdf("./supplement/Sup5_discovery_curve_2014_15.pdf",
    useDingbats = FALSE, width = 8, height = 5)
print(dc)
dev.off()

png(filename = "./supplement/Sup5_discovery_curve_2014_15.png", width = 2000, height = 1300, 
    pointsize = 8,  res = 300)
plot(dc)
dev.off()
